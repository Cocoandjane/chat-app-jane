...
export default function RightHeader() {
    ...
    if (!data.chatId) return (
        <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center h-14">
        </div>
    )
        ...
        <div>
            <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
                ...
                <div className="flex">
                    ...
                    <div className="ml-6" onClick={() => { router.push("/user") }}>
