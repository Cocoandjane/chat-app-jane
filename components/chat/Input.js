...
export default function Input({ allMessages, sendMessage, editMessage, isEdit, setEdit, setmessageOnEdit }) {
        ...
        <div>
            ...
            <div className="bg-grey-lighter px-4 py-4 flex items-center">
                ...
                {isEdit ?
                    ...
                    <div className=" flex flex-row w-full border rounded mx-2 ">
                        <input ref={inputRef} onKeyUp={handleKeyUp}
                            value={isEdit == true ? editMessage.message : ""}
                            onChange={(e) => { setmessageOnEdit({ ...editMessage, message: inputRef.current.value }) }}
                            className="w-full h-full py-2 px-2 !outline-none border-transparent focus:border-transparent focus:ring-0" type="text" />
